...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        {
            var maxSal = Emps.Max(e => e.Salary);
            var employee = Emps.Where(e => e.Salary.Equals(maxSal));
            IEnumerable<Emp> result = employee;
            return result;
        }
        ...
        {
            var emps = Emps.Join(Depts, emp => emp.Deptno, dept => dept.Deptno, (emp, dept) => new
            {
        ...
        {
            var emp = Emps.GroupBy(e => e.Job).Select(e => new
            {
                Praca = e.Key,
                LiczbaPracownikow = e.Count()
            });
            IEnumerable<object> result = emp;
            return result;
        ...
        public static IEnumerable<object> Task10()
        {
            ...
            IEnumerable<object> result = emp.Union(row);
            return result;
        }
        ...
        {
            var emp = Emps.GroupBy(e => e.Deptno).Where(g => g.Count() > 1).Select(e => new
            {
                name = Depts.FirstOrDefault(d => d.Deptno == e.Key)?.Dname,
        ...
        {
            IEnumerable<Emp> result = CustomExtensionMethods.TaskGetEmployees(Emps);
            return result;
        }
    ...
    public static class CustomExtensionMethods
    {
        ...
        public static IEnumerable<Emp> TaskGetEmployees(IEnumerable<Emp> Emps)
        {
            var emp = Emps.Where(e => Emps.Any(m => m.Mgr != null && m.Mgr.Empno == e.Empno)).OrderBy(e => e.Ename)
